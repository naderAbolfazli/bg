...
class PurchaseMessageIPG(BaseMessage):
    def __init__(self, msg, account_number, amount, money_request_type, terminalids, cardacqid):
        ...
        self.money_request_type = str(money_request_type)
        self.terminalId = str(terminalids)
        self.cardAcqId = str(cardacqid)
        # self.ibanNumber = int(ibannumber)
