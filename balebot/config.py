...
class Config:
    ...
    use_graylog = os.environ.get('USE_GRAYLOG', None) or "2"
    source = os.environ.get('LOG_SOURCE', None) or "balegram_bot_source"
    graylog_host = os.environ.get('GRAYLOG_HOST', None) or "192.168.3.193"
    graylog_port = int(os.environ.get('GRAYLOG_PORT', None) or 12201)
    log_level = int(os.environ.get('LOG_LEVEL', None) or logging.DEBUG)
    log_facility_name = os.environ.get('LOG_FACILITY_NAME', None) or "python_bale_bot"
